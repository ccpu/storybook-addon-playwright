...
- add getClientConfig service and integrate selector attributes
...
- add AutoHeightWithTooltip component

## 7.4.1

### Patch Changes

- fix screenshot loading issue
...
- add BrowserManager for managing multiple browser instances
...
- bc27509: fix pre test in ci
- e616699: test release
...
- remove obsolete middleware from routes
...
- update Node version to 24 and specify changesets-autopilot version
...
- update Node version to 24 in setup project
...
- correct regex for Windows path detection
