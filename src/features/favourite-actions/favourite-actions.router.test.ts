...
vi.mock('./favourite-actions.service');
...
describe('favouriteActionsRouter', () => {
  ...
  it('addFavouriteAction calls addFavouriteAction service', async () => {
    (service.addFavouriteAction as Mock).mockResolvedValue(undefined);
  ...
  it('getFavouriteActions calls getFavouriteActions service', async () => {
    ...
    (service.getFavouriteActions as Mock).mockResolvedValue(mockResult);
  ...
  it('deleteFavouriteAction calls deleteFavouriteAction service', async () => {
    (service.deleteFavouriteAction as Mock).mockResolvedValue(undefined);
