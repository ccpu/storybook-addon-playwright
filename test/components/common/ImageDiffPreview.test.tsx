import { ImageDiffPreview } from '../../../src/components/common/ImageDiffPreview';
...
describe('ImageDiffPreview', () => {
  ...
  it('should toggle view', () => {
    ...
    wrapper
      .find(Tabs)
      .props()
      .onChange?.({} as React.ChangeEvent<HTMLDivElement>, 0);
    ...
    wrapper
      .find(Tabs)
      .props()
      .onChange?.({} as React.ChangeEvent<HTMLDivElement>, 1);
