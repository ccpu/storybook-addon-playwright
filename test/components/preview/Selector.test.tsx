...
import { Selector } from '../../../src/components/preview/Selector';
import { shallow } from 'enzyme';
import { useSelectorManager } from '../../../src/hooks/use-selector-manager';
import { SelectorOverlay } from '../../../src/components/preview/SelectorOverlay';

vi.mock(
  '../../../src/hooks/use-selector-manager',
  async () => await import('../../hooks/__mocks__/use-selector-manager'),
);
